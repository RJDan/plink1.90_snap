...
def main():
    ...
    for bfn in bfile_names:
        retval = subprocess.call('plink107  --bfile ' + bfn + ' --silent --nonfounders --max-maf 0.4999 --recode --out test1', shell=True)
        if not retval == 0:
            print('Unexpected error in --file/--maf/--max-maf/--nonfounders/--recode/--write-snplist test.')
            raise SystemExit(1)
        retval = subprocess.call('plink --bfile ' + bfn + ' --silent --nonfounders --max-maf 0.4999 --recode --out test2', shell=True)
        if not retval == 0:
            print('Unexpected error in --file/--maf/--max-maf/--nonfounders/--recode/--write-snplist test.')
            raise SystemExit(1)
        ...
        retval = subprocess.call('plink107  --file test1 --silent --nonfounders --maf 0.04999 --write-snplist --out test1', shell=True)
        if not retval == 0:
            print('Unexpected error in --file/--maf/--max-maf/--nonfounders/--recode/--write-snplist test.')
            raise SystemExit(1)
        retval = subprocess.call('plink --file test2 --silent --nonfounders --maf 0.04999 --write-snplist --out test2', shell=True)
        if not retval == 0:
            print('Unexpected error in --file/--maf/--max-maf/--nonfounders/--recode/--write-snplist test.')
            raise SystemExit(1)
    ...
    for bfn in bfile_names_qt:
        retval = subprocess.call('plink --bfile ' + bfn + ' --silent --recode vcf --out test2', shell=True)
        if not retval == 0:
            print('Unexpected error in --hwe/--recode vcf/--vcf test.')
            raise SystemExit(1)
        retval = subprocess.call('plink107  --bfile ' + bfn + ' --silent --hwe 0.009999 --write-snplist --out test1', shell=True)
        if not retval == 0:
            print('Unexpected error in --hwe/--recode vcf/--vcf test.')
            raise SystemExit(1)
        retval = subprocess.call('plink --vcf test2.vcf --silent --hwe 0.009999 --write-snplist --out test2', shell=True)
        if not retval == 0:
            print('Unexpected error in --hwe/--recode vcf/--vcf test.')
            raise SystemExit(1)
    ...
    for bfn in bfile_names:
        retval = subprocess.call('plink107  --bfile ' + bfn + ' --silent --nonfounders --max-maf 0.4999 --recode --transpose --out test1', shell=True)
        if not retval == 0:
            print('Unexpected error in --missing/--recode transpose/--tfile test.')
            raise SystemExit(1)
        retval = subprocess.call('plink --bfile ' + bfn + ' --silent --nonfounders --max-maf 0.4999 --recode transpose --out test2', shell=True)
        if not retval == 0:
            print('Unexpected error in --missing/--recode transpose/--tfile test.')
            raise SystemExit(1)
        ...
        retval = subprocess.call('plink107  --tfile test1 --silent --missing --out test1', shell=True)
        if not retval == 0:
            print('Unexpected error in --missing/--recode transpose/--tfile test.')
            raise SystemExit(1)
        retval = subprocess.call('plink --tfile test2 --silent --missing --out test2', shell=True)
        if not retval == 0:
            print('Unexpected error in --missing/--recode transpose/--tfile test.')
            raise SystemExit(1)
    ...
    retval = subprocess.call('plink107  --bfile ' + bfile_names_cc[0] + ' --silent --bmerge ' + bfile_names_cc[1] + '.bed ' + bfile_names_cc[1] + '.bim ' + bfile_names_cc[1] + '.fam --max-maf 0.4999 --make-bed --out test1', shell=True)
    if not retval == 0:
        print('Unexpected error in --bmerge/--make-bed test.')
        raise SystemExit(1)
    retval = subprocess.call('plink --bfile ' + bfile_names_cc[0] + ' --silent --bmerge ' + bfile_names_cc[1] + ' --max-maf 0.4999 --make-bed --out test2', shell=True)
    if not retval == 0:
        print('Unexpected error in --bmerge/--make-bed test.')
        raise SystemExit(1)
    ...
    retval = subprocess.call('plink --bfile ' + bfile_names_cc[0] + ' --silent --bmerge ' + bfile_names_cc[1] + ' --max-maf 0.4999 --make-just-bim --out test2', shell=True)
    if not retval == 0:
    ...
    retval = subprocess.call('plink --bfile ' + bfile_names_cc[0] + ' --silent --bmerge ' + bfile_names_cc[1] + ' --make-just-fam --out test2', shell=True)
    if not retval == 0:
        print('Unexpected error in --make-just-bim test.')
        raise SystemExit(1)
    ...
    for bfn in bfile_names_cc:
        ...
        retval = subprocess.call('plink --bfile ' + bfn + ' --silent --geno 0.06049 --max-maf 0.4999 --write-snplist --out test2', shell=True)
        if not retval == 0:
            print('Unexpected error in --extract/--freq/--geno test.')
            raise SystemExit(1)
        retval = subprocess.call('plink107  --bfile ' + bfn + ' --silent --freq --extract test2.snplist --out test1', shell=True)
        if not retval == 0:
            print('Unexpected error in --extract/--freq/--geno test.')
            raise SystemExit(1)
        retval = subprocess.call('plink --bfile ' + bfn + ' --silent --freq --extract test2.snplist --out test2', shell=True)
        if not retval == 0:
            print('Unexpected error in --extract/--freq/--geno test.')
            raise SystemExit(1)
    ...
    for bfn in bfile_names_fam:
        retval = subprocess.call('plink107  --bfile ' + bfn + ' --silent --covar ' + bfn + '.fam --covar-number 3 --filter-founders --write-covar --out test1', shell=True)
        if not retval == 0:
            print('Unexpected error in --covar/--covar-number/--filter-founders/--write-covar test.')
            raise SystemExit(1)
        retval = subprocess.call('plink --bfile ' + bfn + ' --silent --covar ' + bfn + '.fam --covar-number 3 --filter-founders --write-covar --out test2', shell=True)
        if not retval == 0:
            print('Unexpected error in --covar/--covar-number/--filter-founders/--write-covar test.')
            raise SystemExit(1)
    ...
    for bfn in bfile_names:
        retval = subprocess.call('plink107  --bfile ' + bfn + ' --silent --cluster --K 2 --out test1', shell=True)
        if not retval == 0:
            print('Unexpected error in --cluster/--filter-females/--within/--write-cluster test.')
            raise SystemExit(1)
        retval = subprocess.call('plink --bfile ' + bfn + ' --silent --cluster only2 old-tiebreaks --K 2 --out ' + bfn, shell=True)
        if not retval == 0:
            print('Unexpected error in --cluster/--filter-females/--within/--write-cluster test.')
            raise SystemExit(1)
        ...
        if not retval == 0:
            ...
            raise SystemExit(1)
        retval = subprocess.call('plink107  --bfile ' + bfn + ' --silent --within ' + bfn + '.cluster2 --filter-females --write-cluster --out test1', shell=True)
        if not retval == 0:
            print('Unexpected error in --cluster/--filter-females/--within/--write-cluster test.')
            raise SystemExit(1)
        retval = subprocess.call('plink --bfile ' + bfn + ' --silent --within ' + bfn + '.cluster2 --filter-females --write-cluster --out test2', shell=True)
        if not retval == 0:
            print('Unexpected error in --cluster/--filter-females/--within/--write-cluster test.')
            raise SystemExit(1)
    ...
    for bfn in bfile_names:
        retval = subprocess.call('plink107  --bfile ' + bfn + ' --silent --make-set set.txt --write-set --out test1', shell=True)
        if not retval == 0:
            print('Unexpected error in --make-set/--set/--set-table/--write-set test.')
            raise SystemExit(1)
        retval = subprocess.call('plink --bfile ' + bfn + ' --silent --make-set set.txt --write-set --out test2', shell=True)
        if not retval == 0:
            print('Unexpected error in --make-set/--set/--set-table/--write-set test.')
            raise SystemExit(1)
        ...
        if not retval == 0:
            ...
            raise SystemExit(1)
        retval = subprocess.call('plink107  --bfile ' + bfn + ' --silent --make-set set.txt --set-table --out test1', shell=True)
        if not retval == 0:
            print('Unexpected error in --make-set/--set/--set-table/--write-set test.')
            raise SystemExit(1)
        retval = subprocess.call('plink --bfile ' + bfn + ' --silent --set test2.set --set-table --out test2', shell=True)
        if not retval == 0:
            print('Unexpected error in --make-set/--set/--set-table/--write-set test.')
            raise SystemExit(1)
    ...
    retval = subprocess.call('plink --bfile ' + bfile_names_cc[1] + ' --silent --recode --out test2', shell=True)
    if not retval == 0:
        print('Unexpected error in --merge test.')
        raise SystemExit(1)
    retval = subprocess.call('plink --bfile ' + bfile_names_cc[0] + ' --silent --merge test2 --max-maf 0.4999 --make-bed --out test2', shell=True)
    if not retval == 0:
        print('Unexpected error in --merge test.')
        raise SystemExit(1)
    retval = subprocess.call('diff -q test1.bed test2.bed', shell=True)
    ...
    if not retval == 0:
        print('Unexpected error in --merge-list test.')
        raise SystemExit(1)
    retval = subprocess.call('plink --merge-list merge_list.txt --silent --max-maf 0.4999 --make-bed --out test2', shell=True)
    if not retval == 0:
        print('Unexpected error in --merge-list test.')
        raise SystemExit(1)
    retval = subprocess.call('diff -q test1.bed test2.bed', shell=True)
    ...
    for bfn in bfile_names_cc:
        ...
        retval = subprocess.call('plink107  --bfile ' + bfn + ' --silent --flip-scan --mind 0.05399 --maf 0.4876 --max-maf 0.4999 --out test1', shell=True)
        if not retval == 0:
            print('Unexpected error in --flip-scan/--mind test.')
            raise SystemExit(1)
        retval = subprocess.call('plink --bfile ' + bfn + ' --silent --flip-scan --mind 0.05399 --maf 0.4876 --max-maf 0.4999 --out test2', shell=True)
        if not retval == 0:
            print('Unexpected error in --flip-scan/--mind test.')
            raise SystemExit(1)
    ...
    for bfn in bfile_names_cc:
        # force at least 14 to be missing out of 513...
        retval = subprocess.call('plink --bfile ' + bfn + ' --silent --geno 0.0254 --write-snplist --out test1', shell=True)
        if not retval == 0:
        ...
        retval = subprocess.call('plink --bfile ' + bfn + ' --silent --exclude test1.snplist --geno 0.06049 --write-snplist --out test2', shell=True)
        if not retval == 0:
            print('Unexpected error in --exclude/--hardy test.')
            raise SystemExit(1)

        retval = subprocess.call('plink107  --bfile ' + bfn + ' --silent --extract test2.snplist --hardy --out test1', shell=True)
        if not retval == 0:
            print('Unexpected error in --exclude/--hardy test.')
            raise SystemExit(1)
        retval = subprocess.call('plink --bfile ' + bfn + ' --silent --extract test2.snplist --hardy --out test2', shell=True)
        if not retval == 0:
            print('Unexpected error in --exclude/--hardy test.')
            raise SystemExit(1)
    ...
    for bfn in bfile_names_fam:
        retval = subprocess.call('plink107  --bfile ' + bfn + ' --silent --mendel --out test1', shell=True)
        if not retval == 0:
            print('Unexpected error in --mendel test.')
            raise SystemExit(1)
        retval = subprocess.call('plink --bfile ' + bfn + ' --silent --mendel --out test2', shell=True)
        if not retval == 0:
            print('Unexpected error in --mendel test.')
            raise SystemExit(1)
    ...
    for bfn in bfile_names:
        retval = subprocess.call('plink --bfile ' + bfn + ' --silent --recode oxford --out test2', shell=True)
        if not retval == 0:
            print('Unexpected error in --data/--het/--recode oxford test.')
            raise SystemExit(1)
        retval = subprocess.call('plink107  --bfile ' + bfn + ' --silent --het --nonfounders --out test1', shell=True)
        if not retval == 0:
            print('Unexpected error in --data/--het/--recode oxford test.')
            raise SystemExit(1)
        retval = subprocess.call('plink --data test2 --silent --het --out test2', shell=True)
        if not retval == 0:
            print('Unexpected error in --data/--het/--recode oxford test.')
            raise SystemExit(1)
    ...
    for bfn in bfile_names_cc:
        ...
        if not retval == 0:
            ...
            raise SystemExit(1)
        retval = subprocess.call('plink --bed ' + bfn + '.bed --bim test1.bim.tmp --fam ' + bfn + '.fam --silent --freq --out test1', shell=True)
        if not retval == 0:
            print('Unexpected error in --check-sex/--impute-sex/--read-freq test.')
            raise SystemExit(1)
        retval = subprocess.call('plink107  --bed ' + bfn + '.bed --bim test1.bim.tmp --fam ' + bfn + '.fam --silent --read-freq test1.frq --check-sex --out test1', shell=True)
        if not retval == 0:
            print('Unexpected error in --check-sex/--impute-sex/--read-freq test.')
            raise SystemExit(1)
        retval = subprocess.call('plink --bed ' + bfn + '.bed --bim test1.bim.tmp --fam ' + bfn + '.fam --silent --read-freq test1.frq --check-sex --out test2', shell=True)
        if not retval == 0:
            print('Unexpected error in --check-sex/--impute-sex/--read-freq test.')
            raise SystemExit(1)
        ...
        if not retval == 0:
            ...
            raise SystemExit(1)
        retval = subprocess.call('plink107  --bed ' + bfn + '.bed --bim test1.bim.tmp --fam ' + bfn + '.fam --silent --read-freq test1.frq --maf 0.4876 --max-maf 0.4999 --impute-sex --make-bed --out test1', shell=True)
        if not retval == 0:
            print('Unexpected error in --check-sex/--impute-sex/--read-freq test.')
            raise SystemExit(1)
        retval = subprocess.call('plink --bed ' + bfn + '.bed --bim test1.bim.tmp --fam ' + bfn + '.fam --silent --read-freq test1.frq --maf 0.4876 --max-maf 0.4999 --impute-sex --make-bed --out test2', shell=True)
        if not retval == 0:
            print('Unexpected error in --check-sex/--impute-sex/--read-freq test.')
            raise SystemExit(1)
        retval = subprocess.call('diff -q test1.sexcheck test2.sexcheck', shell=True)
    ...
    for bfn in bfile_names:
        retval = subprocess.call('plink107  --bfile ' + bfn + ' --silent --r2 --out test1', shell=True)
        if not retval == 0:
            print('Unexpected error in --r2 test.')
            raise SystemExit(1)
        retval = subprocess.call('plink --bfile ' + bfn + ' --silent --r2 --out test2', shell=True)
        if not retval == 0:
            print('Unexpected error in --r2 test.')
            raise SystemExit(1)
    ...
    for bfn in bfile_names:
        retval = subprocess.call('plink --bfile ' + bfn + ' --silent --make-set set.txt --write-set --out test1', shell=True)
        if not retval == 0:
            print('Unexpected error in --gene/--show-tags test.')
            raise SystemExit(1)
        retval = subprocess.call('plink107  --bfile ' + bfn + ' --silent --set test1.set --gene set2 --show-tags all --tag-r2 0.031 --out test1', shell=True)
        if not retval == 0:
            print('Unexpected error in --gene/--show-tags test.')
            raise SystemExit(1)
        retval = subprocess.call('plink --bfile ' + bfn + ' --silent --make-set set.txt --gene set2 --show-tags all --tag-r2 0.031 --out test2', shell=True)
        if not retval == 0:
            print('Unexpected error in --gene/--show-tags test.')
            raise SystemExit(1)
    ...
    for bfn in bfile_names:
        retval = subprocess.call('plink107  --bfile ' + bfn + ' --silent --cluster --distance-matrix --out test1', shell=True)
        if not retval == 0:
            print('Unexpected error in --distance-matrix test.')
            raise SystemExit(1)
        retval = subprocess.call('plink --bfile ' + bfn + ' --silent --distance-matrix --out test2', shell=True)
        if not retval == 0:
            print('Unexpected error in --distance-matrix test.')
            raise SystemExit(1)
    ...
    for bfn in bfile_names:
        retval = subprocess.call('plink107  --bfile ' + bfn + ' --silent --genome --out test1', shell=True)
        if not retval == 0:
            print('Unexpected error in --genome test.')
            raise SystemExit(1)
        retval = subprocess.call('plink --bfile ' + bfn + ' --silent --genome --out test2', shell=True)
        if not retval == 0:
            print('Unexpected error in --genome test.')
            raise SystemExit(1)
    ...
    for bfn in bfile_names:
        retval = subprocess.call('plink107  --bfile ' + bfn + ' --silent --homozyg --out test1', shell=True)
        if not retval == 0:
            print('Unexpected error in --homozyg test.')
            raise SystemExit(1)
        retval = subprocess.call('plink --bfile ' + bfn + ' --silent --homozyg subtract-1-from-lengths --out test2', shell=True)
        if not retval == 0:
            print('Unexpected error in --homozyg test.')
            raise SystemExit(1)
    ...
    for bfn in bfile_names_cc:
        retval = subprocess.call('plink107  --bfile ' + bfn + ' --silent --assoc --max-maf 0.4999 --out test1', shell=True)
        if not retval == 0:
            print('Unexpected error in case/control --assoc test.')
            raise SystemExit(1)
        retval = subprocess.call('plink --bfile ' + bfn + ' --silent --assoc --max-maf 0.4999 --out test2', shell=True)
        if not retval == 0:
            print('Unexpected error in case/control --assoc test.')
            raise SystemExit(1)
    ...
    for bfn in bfile_names_cc:
        retval = subprocess.call('plink107  --bfile ' + bfn + ' --silent --max-maf 0.4999 --model --out test1', shell=True)
        if not retval == 0:
            print('Unexpected error in --model test.')
            raise SystemExit(1)
        retval = subprocess.call('plink --bfile ' + bfn + ' --silent --max-maf 0.4999 --model --out test2', shell=True)
        if not retval == 0:
            print('Unexpected error in --model test.')
            raise SystemExit(1)
    ...
    for bfn in bfile_names_cc:
        retval = subprocess.call('plink107  --bfile ' + bfn + ' --silent --within ' + bfn + '.cluster2 --max-maf 0.4999 --bd --out test1', shell=True)
        if not retval == 0:
            print('Unexpected error in --bd test.')
            raise SystemExit(1)
        retval = subprocess.call('plink --bfile ' + bfn + ' --silent --within ' + bfn + '.cluster2 --max-maf 0.4999 --bd --out test2', shell=True)
        if not retval == 0:
            print('Unexpected error in --bd test.')
            raise SystemExit(1)
    ...
    for bfn in bfile_names_cc:
        retval = subprocess.call('plink107  --bfile ' + bfn + ' --silent --within ' + bfn + '.cluster2 --max-maf 0.4999 --homog --out test1', shell=True)
        if not retval == 0:
            print('Unexpected error in --homog test.')
            raise SystemExit(1)
        retval = subprocess.call('plink --bfile ' + bfn + ' --silent --within ' + bfn + '.cluster2 --max-maf 0.4999 --homog --out test2', shell=True)
        if not retval == 0:
            print('Unexpected error in --homog test.')
            raise SystemExit(1)
    ...
    for bfn in bfile_names_qt:
        retval = subprocess.call('plink --bfile ' + bfn + ' --silent --cluster --K 3 --out test1', shell=True)
        if not retval == 0:
            print('Unexpected error in --gxe test.')
            raise SystemExit(1)
        retval = subprocess.call('plink107  --bfile ' + bfn + ' --silent --gxe --covar test1.cluster2 --max-maf 0.4999 --out test1', shell=True)
        if not retval == 0:
            print('Unexpected error in --gxe test.')
            raise SystemExit(1)
        retval = subprocess.call('plink --bfile ' + bfn + ' --silent --gxe --covar test1.cluster2 --max-maf 0.4999 --out test2', shell=True)
        if not retval == 0:
            print('Unexpected error in --gxe test.')
            raise SystemExit(1)
    ...
    retval = subprocess.call('plink107  --bfile ' + bfile_names_qt[0] + ' --silent --adjust --linear --covar ' + bfile_names_cc[0] + '.fam --covar-number 4 --out test1', shell=True)
    if not retval == 0:
        print('Unexpected error in --adjust/--linear test.')
        raise SystemExit(1)
    retval = subprocess.call('plink --bfile ' + bfile_names_qt[0] + ' --silent --adjust --linear --covar ' + bfile_names_cc[0] + '.fam --covar-number 4 --out test2', shell=True)
    if not retval == 0:
        print('Unexpected error in --adjust/--linear test.')
        raise SystemExit(1)
    ...
    for bfn in bfile_names_qt:
        retval = subprocess.call('plink --bfile ' + bfn + ' --silent --recode oxford --out test1', shell=True)
        if not retval == 0:
            print('Unexpected error in --dosage test.')
            raise SystemExit(1)
        retval = subprocess.call('plink107  --silent --dosage test1.gen noheader skip0=1 skip1=1 format=3 --fam ' + bfn + '.fam --covar ' + bfile_names_cc[0] + '.fam --covar-number 4 --out test1', shell=True)
        if not retval == 0:
            print('Unexpected error in --dosage test.')
            raise SystemExit(1)
        retval = subprocess.call('plink --silent --dosage test1.gen noheader skip0=1 skip1=1 format=3 --fam ' + bfn + '.fam --covar ' + bfile_names_cc[0] + '.fam --covar-number 4 --out test2', shell=True)
        if not retval == 0:
            print('Unexpected error in --dosage test.')
            raise SystemExit(1)
    ...
    # complicates things
    retval = subprocess.call('plink107  --bfile ' + bfile_names_cc[1] + ' --silent --test-missing --out test1', shell=True)
    if not retval == 0:
        print('Unexpected error in --test-missing test.')
        raise SystemExit(1)
    retval = subprocess.call('plink --bfile ' + bfile_names_cc[1] + ' --silent --test-missing --out test2', shell=True)
    if not retval == 0:
        print('Unexpected error in --test-missing test.')
        raise SystemExit(1)
    ...
    for bfn in bfile_names_fam:
        retval = subprocess.call('plink107  --bfile ' + bfn + ' --silent --tdt --out test1', shell=True)
        if not retval == 0:
            print('Unexpected error in --tdt test.')
            raise SystemExit(1)
        retval = subprocess.call('plink --bfile ' + bfn + ' --silent --tdt --out test2', shell=True)
        if not retval == 0:
            print('Unexpected error in --tdt test.')
            raise SystemExit(1)
    ...
    # for bfn in bfile_names_qt:
    #     retval = subprocess.call('plink --bfile ' + bfn + ' --silent --linear --out test1', shell=True)
    #     if not retval == 0:
    #         print('Unexpected error in --annotate test.')
    #         raise SystemExit(1)
    #     retval = subprocess.call('plink107  --silent --annotate test1.assoc.linear ranges=set.txt --out test1', shell=True)
    #     if not retval == 0:
    #         print('Unexpected error in --annotate test.')
    #         raise SystemExit(1)
    #     retval = subprocess.call('plink --silent --annotate test1.assoc.linear ranges=set.txt --out test2', shell=True)
    #     if not retval == 0:
    #         print('Unexpected error in --annotate test.')
    #         raise SystemExit(1)
    ...
    for bfn in bfile_names_cc:
        retval = subprocess.call('plink107  --bfile ' + bfn + ' --silent --fast-epistasis --out test1', shell=True)
        if not retval == 0:
            print('Unexpected error in --epistasis-summary-merge/--fast-epistasis/--parallel test.')
            raise SystemExit(1)
        retval = subprocess.call('plink --bfile ' + bfn + ' --silent --fast-epistasis no-ueki --parallel 1 2 --out test2', shell=True)
        if not retval == 0:
            print('Unexpected error in --epistasis-summary-merge/--fast-epistasis/--parallel test.')
            raise SystemExit(1)
        retval = subprocess.call('plink --bfile ' + bfn + ' --silent --fast-epistasis no-ueki --parallel 2 2 --out test2', shell=True)
        if not retval == 0:
            print('Unexpected error in --epistasis-summary-merge/--fast-epistasis/--parallel test.')
            raise SystemExit(1)
        ...
        if not retval == 0:
            print('Unexpected error in --epistasis-summary-merge/--fast-epistasis/--parallel test.')
            raise SystemExit(1)
        retval = subprocess.call('plink --epistasis-summary-merge test2.epi.cc 2 --silent --out test2', shell=True)
        if not retval == 0:
            print('Unexpected error in --epistasis-summary-merge/--fast-epistasis/--parallel test.')
            raise SystemExit(1)
    ...
    for bfn in bfile_names_qt:
        retval = subprocess.call('plink107  --bfile ' + bfn + ' --silent --score score.txt --out test1', shell=True)
        if not retval == 0:
            print('Unexpected error in --score test.')
            raise SystemExit(1)
        retval = subprocess.call('plink --bfile ' + bfn + ' --silent --score score.txt --out test2', shell=True)
        if not retval == 0:
            print('Unexpected error in --score test.')
            raise SystemExit(1)
